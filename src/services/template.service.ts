...
export class TemplateService {
  private static includesPath = path.join(__dirname, '../../includes');
   ...
   */
  static async loadInclude(filename: string): Promise<string> {
    ...
    try {
      const filePath = path.join(this.includesPath, filename);
