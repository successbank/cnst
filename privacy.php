    ...
    <div class="legal-container">
        ...
        <div class="legal-content">
            <section class="legal-section">
                <p class="legal-intro">주식회사 충남스틸(이하 "회사")은 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 개인정보처리방침을 두고 있습니다.</p>
            </section>
            ...
            <section class="legal-section">
                ...
                <p>물품배송, 서비스 제공, 계약서·청구서 발송, 콘텐츠 제공, 맞춤서비스 제공, 본인인증, 요금결제·정산을 목적으로 개인정보를 처리합니다.</p>
            ...
            <section class="legal-section">
                ...
                <h3>1. 회원가입 시</h3>
                <ul>
                    <li>필수항목: 성명, 아이디, 비밀번호, 이메일, 휴대전화번호</li>
                    <li>선택항목: 주소, 회사명, 부서, 직책</li>
                </ul>
                
                <h3>2. 재화 또는 서비스 제공 시</h3>
                <ul>
                    <li>성명, 주소, 전화번호, 이메일, 결제정보</li>
                </ul>
                
                <h3>3. 서비스 이용 과정에서 자동으로 생성되어 수집되는 정보</h3>
                <ul>
                    <li>IP주소, 쿠키, 서비스 이용기록, 방문기록</li>
                </ul>
            </section>
            ...
            <section class="legal-section">
                ...
                <p>회사는 정보주체의 개인정보를 제1조(개인정보의 수집 및 이용목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.</p>
            </section>
            ...
            <section class="legal-section">
                ...
                <p>권리 행사는 회사에 대해 개인정보 보호법 시행규칙 별지 제8호 서식에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 회사는 이에 대해 지체 없이 조치하겠습니다.</p>
            </section>
            ...
            <section class="legal-section">
                ...
                <h3>1. 파기절차</h3>
                <p>이용자가 입력한 정보는 목적 달성 후 별도의 DB에 옮겨져(종이의 경우 별도의 서류) 내부 방침 및 기타 관련 법령에 따라 일정기간 저장된 후 파기됩니다.</p>
            ...
            <section class="legal-section">
                ...
                <p>정보주체께서는 회사의 서비스를 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자에게 문의하실 수 있습니다.</p>
            </section>
                ...
                <ul>
                    <li>개인정보보호 종합지원 포털 (행정안전부 운영)
                        <ul>
                            ...
                            <li>홈페이지: www.privacy.kisa.or.kr</li>
                            <li>전화: (국번없이) 118</li>
                        </ul>
                    </li>
                    ...
                    <li>대검찰청 사이버수사과: 02-3480-3573 (www.spo.go.kr)</li>
            ...
            <div class="legal-footer">
                <p><strong>공고일자: 2024년 12월 25일</strong></p>
