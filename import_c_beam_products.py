...
"""
C형강 제품 임포트 스크립트
파일: /home/successbank/projects/docker/project1/html/114/6/C형강.xlsx
제품 수: 46개
"""
...
# Excel 파일 읽기
excel_file = '/home/successbank/projects/docker/project1/html/114/6/C형강.xlsx'
...
for idx, row in df.iterrows():
    try:
        ...
        # 제품명 생성 (규격의 * 를 × 로 변환)
        product_name = f"C형강 {spec.replace('*', '×')}"
        ...
        cursor.execute("""
            ...
            VALUES (%s, %s, %s, 'c-beam', 'linear', %s, 1)
