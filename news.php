...
<section class="board-section">
    <div class="board-container">
            ...
            <tbody>
                ...
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($post['source']): ?>
                                <span class="news-source"><?php echo escape($post['source']); ?></span>
                            <?php else: ?>
                                -
                            <?php endif; ?>
                        </td>
        ...
        <div class="board-buttons">
            <a href="board_write.php?type=news" class="write-btn">글쓰기</a>
        </div>
...
@media (max-width: 768px) {
    ...
    .board-table th:nth-child(6) { width: 15%; }  /* 조회 */
}
</style>
