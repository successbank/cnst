...
"""
구조관 제품 임포트 스크립트
파일: /home/successbank/projects/docker/project1/html/114/8/구조관.xlsx
제품 수: 10개
"""
...
# Excel 파일 읽기
excel_file = '/home/successbank/projects/docker/project1/html/114/8/구조관.xlsx'
...
for idx, row in df.iterrows():
    try:
        ...
        cursor.execute("""
            ...
            VALUES (%s, %s, %s, 'structural-pipe', 'linear', %s, 1)
