...
function simulateExcelData($korean_name) {
    $sample_data = [
        ...
        '사각파이프' => [
            '15*15*1.0T' => ['HR' => 0.419, 'SS400' => 0.419],
            '15*15*1.2T' => ['COLOR' => 0.491, 'SS400' => 0.491],
            '15*15*1.6T' => ['HGI' => 0.621, 'SS400' => 0.621],
            '19*19*1.0T' => ['GI' => 0.545, 'SS400' => 0.545],
            '19*19*1.2T' => ['SS400' => 0.642],
            '19*19*1.6T' => ['SS400' => 0.822],
            '20*20*1.2T' => ['SS400' => 0.697],
            '20*20*1.4T' => ['SS400' => 0.872],
            '25*25*1.2T' => ['SS400' => 0.867],
            '25*25*1.4T' => ['SS400' => 1.12],
            '30*30*1.2T' => ['SS400' => 1.06],
            '30*30*1.4T' => ['SS400' => 1.38],
            '40*40*1.4T' => ['SS400' => 1.88],
            '40*40*2.0T' => ['SS400' => 2.62],
            '50*50*1.4T' => ['SS400' => 2.38],
            '50*50*2.0T' => ['SS400' => 3.34],
            '50*50*2.9T' => ['SS400' => 4.5],
            '75*75*1.4T' => ['SS400' => 3.64],
            '75*75*2.0T' => ['SS400' => 5.14],
            '75*75*2.9T' => ['SS400' => 7.01],
            '100*100*2.0T' => ['SS400' => 6.95],
            '100*100*2.9T' => ['SS400' => 9.52],
            '100*100*4.0T' => ['SS400' => 11.7],
            '100*100*6.0T' => ['SS400' => 17.0],
            '100*100*9.0T' => ['SS400' => 24.1],
            '125*125*2.9T' => ['SS400' => 12.0],
            '125*125*4.0T' => ['SS400' => 16.6],
            '125*125*5.0T' => ['SS400' => 18.3],
            '125*125*6.0T' => ['SS400' => 21.7],
            '125*125*9.0T' => ['SS400' => 31.1],
            '150*150*4.0T' => ['SS400' => 20.1],
            '150*150*5.0T' => ['SS400' => 22.3],
            '150*150*6.0T' => ['SS400' => 26.4],
            '150*150*9.0T' => ['SS400' => 38.21],
            '200*200*4.5T' => ['SS400' => 27.2],
            '200*200*5.0T' => ['SS400' => 35.8],
            '200*200*6.0T' => ['SS400' => 46.9],
            '200*200*9.0T' => ['SS400' => 52.3],
            '250*250*5.0T' => ['SS400' => 38.0],
            '250*250*6.0T' => ['SS400' => 45.2],
            '250*250*8.0T' => ['SS400' => 59.5],
            '250*250*9.0T' => ['SS400' => 66.5]
        ],
        'BS파이프' => [
            '15A' => 0.82,
            '20A' => 1.05,
        ...
        '데크플레이트' => [
            '614*50*1.2T' => ['SS400' => 8.24, 'GI' => 8.58],
            '614*50*1.6T' => ['SS400' => 10.99, 'GI' => 11.32],
            '660*50*1.2T' => ['SS400' => 8.61, 'GI' => 8.96],
            '660*50*1.6T' => ['SS400' => 11.48, 'GI' => 11.83],
            '600*75*1.2T' => ['SS400' => 9.38, 'GI' => 9.76],
            '600*75*1.6T' => ['SS400' => 12.5, 'GI' => 12.9],
            '600*100*1.2T' => ['SS400' => 10.83, 'GI' => 11.21],
            '600*100*1.6T' => ['SS400' => 14.44]
        ],
        '레일' => [
            '9kg' => 8.94,
            '15kg' => 15.2,
...
try {
    ...
    foreach ($category_mapping as $korean_name => $config) {
        ...
        $unit_weight_data = [];
        $specifications = [];
        $all_materials = ['SS400']; // 기본 재질 포함
        
        foreach ($excel_data as $spec => $weight_data) {
            // 새로운 형식: 재질별 중량 데이터
            if (is_array($weight_data)) {
                $unit_weight_data[$spec] = $weight_data;
                foreach (array_keys($weight_data) as $material) {
                    if (!in_array($material, $all_materials)) {
                        $all_materials[] = $material;
                    }
                }
            } else {
                // 기존 형식: 단일 중량 값
                $unit_weight_data[$spec] = ['SS400' => $weight_data];
            }
            $specifications[] = $spec;
        }
