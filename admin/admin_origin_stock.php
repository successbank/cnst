...
<div class="admin-content">
    <div class="page-header">
        <h2>원산지 재고 형식</h2>
        <p>제품군 단위로 개별 제품의 원산지와 재고 상태를 관리합니다.</p>
    </div>
    ...
    <div class="bulk-action-section">
        ...
        <div class="bulk-actions">
            <div class="action-card">
                <h4>원산지 및 재고 상태 관리</h4>
                <p>카테고리를 선택하면 해당 제품 목록이 표시됩니다. 각 제품의 원산지와 재고 상태를 개별적으로 선택하여 변경할 수 있습니다.</p>
                ...
                <div id="products_list_origin" style="display: none;">
                    <form method="post" action="admin_origin_stock_action.php" onsubmit="return validateProductForm();">
                        <input type="hidden" name="action" value="update_products_origin_stock">
                        ...
                        <div class="form-actions" style="margin-top: 20px; display: none;">
                            ...
                            <button type="submit" class="btn btn-warning">선택한 제품 변경 사항 저장</button>
                        </div>
                    </form>
                </div>
            </div>
...
function updateFormActions() {
    ...
    if (submitBtn) {
        submitBtn.textContent = `선택한 제품(${checkedBoxes.length}개) 변경 사항 저장`;
    }
}
