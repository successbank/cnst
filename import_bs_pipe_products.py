...
"""
BS파이프 제품 임포트 스크립트
파일: /home/successbank/projects/docker/project1/html/114/8/BS파이프.xlsx
제품 수: 13개
"""
...
# Excel 파일 읽기
excel_file = '/home/successbank/projects/docker/project1/html/114/8/BS파이프.xlsx'
df = pd.read_excel(excel_file, engine='openpyxl', header=1)

print("=== BS파이프 제품 임포트 시작 ===\n")
...
for idx, row in df.iterrows():
    try:
        ...
        cursor.execute("""
            ...
            VALUES (%s, %s, %s, 'bs-pipe', 'linear', %s, 1)
