...
/* Responsive - 모바일에서 작성자, 작성일 컬럼 숨김 */
@media (max-width: 768px) {
    ...
    .board-table th:nth-child(2) { width: 60%; }  /* 제목 */
    .board-table th:nth-child(5) { width: 10%; }  /* 조회 */
    .board-table th:nth-child(6) { width: 20%; }  /* 답변상태 */
    ...
    <div class="board-container">
        ...
        <div class="board-notice">
            ...
            <ul>
                ...
                <li>긴급한 견적은 대표전화(032-564-1616)로 연락 주시기 바랍니다.</li>
            </ul>
        </div>
    </div>
</section>
